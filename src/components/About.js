      ...
      <div className="py-4 px-10 text-white">
        ...
        <section className="mt-4 mb-8 pl-3">
          ...
          <p className={`${styles.paragraph} max-w-5xl m-auto`}>
            I am <strong>Akli YALAOUI</strong>, I am a 21 years old full stack{" "}
            <strong>MERN developer</strong> . I am an ambitious student with a
            fast learning curve, I like creativity and solving complex problems
            both in web development and everyday life.
          </p>
        </section>
